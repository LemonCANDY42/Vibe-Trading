...
import { Activity, BarChart3, Bot, FileText, Gauge, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2 } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/reports", icon: FileText, label: t('layout.reports', { defaultValue: "Reports" }) },
    { to: "/usage", icon: Gauge, label: t('layout.usage', { defaultValue: "Usage" }) },
